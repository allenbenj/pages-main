...
model: 'gpt-4o'
tools: [vscode, execute, read, agent, vscode.mermaid-markdown-features, ms-python.python, ms-toolsai.jupyter, VijayNirmal.playwright-mcp-relay, edit, search, web, browser, 'microsoft/markitdown/*', 'microsoft-learn/*', todo]
